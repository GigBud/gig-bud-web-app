				...
				<div className={styles.cards}>
					<div className={styles.row}>
						...
						<div className={styles.card}>
							...
							<div className={styles.header}>
								<Image className={styles.card_icon} width={60} height={50} src="/images/jobs/first.png" alt="" />
						...
						<div className={styles.card}>
							{/* Card Icon , Title , Position*/}
							<div className={styles.header}>
								<Image className={styles.card_icon} width={60} height={50} src="/images/jobs/second.png" alt="" />
					...
					<div className={styles.row}>
						...
						<div className={styles.card}>
							{/* Card Icon , Title , Position*/}
							<div className={styles.header}>
								<Image className={styles.card_icon} width={60} height={50} src="/images/jobs/third.png" alt=" " />
								<div className={styles.card_info}>
									<h2 className={styles.card_title}>UI Designer</h2>
									<FontAwesomeIcon className={styles.plus} icon={faPlus} />
						...
						<div className={styles.card}>
							{/* Card Icon , Title , Position*/}
							<div className={styles.header}>
								<Image className={styles.card_icon} width={60} height={50} src="/images/jobs/fourth.png" alt="" />
								<div className={styles.card_info}>
					...
					<div className={styles.row}>
						...
						<div className={styles.card}>
							{/* Card Icon , Title , Position*/}
							<div className={styles.header}>
								<Image className={styles.card_icon} width={60} height={50} src="/images/jobs/fifth.png" alt="" />
								<div className={styles.card_info}>
						...
						<div className={styles.card}>
							{/* Card Icon , Title , Position*/}
							<div className={styles.header}>
								<Image className={styles.card_icon} width={60} height={50} src="/images/jobs/sixth.png" alt="" />
								<div className={styles.card_info}>
									<h2 className={styles.card_title}>UX Designer</h2>
									<FontAwesomeIcon className={styles.plus} icon={faPlus} />
									<span>Senior</span>
